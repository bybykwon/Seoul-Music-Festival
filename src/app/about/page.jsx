...
const timeline = [
    ...
    },
    {
        name: 'Released beta',
        description:
            'Sunt perspiciatis incidunt. Non necessitatsibus aliquid. Consequatur ut officiis earum eum quia facilis. Hic deleniti dolorem quia et.',
        date: 'Feb 2022',
        dateTime: '2022-02',
    },
    {
            ...
            <div className='mx-auto mt-32 max-w-7xl sm:mt-40 sm:px-6 lg:px-8'>
                <div className='relative isolate overflow-hidden bg-gray-900 px-6 py-24 text-center shadow-2xl sm:rounded-3xl sm:px-16'>
                    ...
                    <p className='mx-auto mt-6 max-w-xl text-lg/8 text-gray-300'>
                        Aliquip reprehenderit incididunt amet quis fugiat ut velit. Sit occaecat labore proident cillum
                        in nisi adipisicing officia excepteur tempor deserunt.
                    </p>
            ...
            <div className='mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8'>
                <div className='mx-auto max-w-2xl lg:mx-0'>
                    ...
                    <p className='mt-6 text-base/7 text-gray-600'>
                        ...
                        nam arcu. Cras purus nibh cursus sit eu in id. Integer vel nibh.
                    </p>
                </div>
