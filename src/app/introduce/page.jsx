    ...
    return (
        <div>
            ...
            <div className='min-h-screen flex flex-col items-center justify-center p-5'>
                <Image
                    className='h-[80vh] w-[50vh] object-contain
								 object-center 
						animate-slide-up'
                ...
                <p className='mb-2 text-lg font-bold animate-slide-up delay-1000'>
                    노들섬에서 듣는 나만의 감성 플레이리스트 전 장르를 아우르는 대중음악을 통해 서울의 밤을 더 뜨겁게
                    달궈 시민과 함께 만드는 문화매력도시 서울을 보여줄 2024서울뮤직페스티벌
                </p>
                <p className='mb-2 text-lg font-bold animate-slide-up delay-2000'>
